...
function setup() {
  ...
  block19 = new Block(690,180,30,40);
  ...
  block25 = new Block(690,100,30,40);



  polygon_img=new polygon(50,200,50,50);
  
  slingShot=new SlingShot(polygon_img.body,{x:100,y:200})
}
function draw() {
  background(56,44,44); 
